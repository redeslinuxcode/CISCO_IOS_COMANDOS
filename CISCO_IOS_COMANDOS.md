...
## RIPv2:
**É um protocolo de roteamento que vai escolher o provixo salto apartir da distancia entre um roteador e outro. Não utilizato atualmente é usado apenas para estudos**
...
**Determinar Versão do RIPv2**
~~~
version 2
~~~

**Comando para melhor visualização da tabela de roteamento**
O comando “no auto-summary” desabilita a sumarização automática em redes classfull(ip's de classe cheia)
...
**comando para propagar uma rota padrão**
~~~
default-information originate
~~~

**Desativar o RIPv2 em interfaces que não estão em uso**
essa comando irá diminuir o processamento do route
~~~~
passive-interface [interface que não esta em uso]
~~~~

# VTP
**protocolo usado para propragação de VLAN, onde iremos determinar um switch SERVER e switchs CLIENT**
